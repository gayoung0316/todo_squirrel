      ...
      body: ListView(
        ...
        children: [
          ...
          FailureCharacterBox(
            ...
            characterGoalSuccessPercent: double.parse('0.3'),
          ),
          ...
          FailureCharacterBox(
            ...
            characterStartGoal: '2022.02.04',
            characterEndGoal: '2022.02.14',
            characterGoalSuccessPercent: double.parse('0.7'),
          ),
          SizedBox(height: 40.h),
          FailureCharacterBox(
            characterIdx: 3,
            ...
            characterStartGoal: '2022.02.04',
            characterEndGoal: '2022.02.14',
            characterGoalSuccessPercent: double.parse('0.9'),
          ),
          SizedBox(height: 40.h),
          FailureCharacterBox(
            characterIdx: 4,
            ...
            characterStartGoal: '2022.02.04',
            characterEndGoal: '2022.02.14',
            characterGoalSuccessPercent: double.parse('0.1'),
          ),
          SizedBox(height: 40.h),
        ],
      ),
